...
<body>
	<form action="" method="post">
		<main>
			...
			User<input id="user_input" type="text" name="user_input" required=""></input>
			Password<input id="password_input" type="password" name="password_input" minlength="8" maxlength="16" required=""></input>
			Confirm Password<input id="conpassword_input" type="password" name="conpassword_input" required=""></input>
